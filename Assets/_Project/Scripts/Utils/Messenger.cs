...
static public class Messenger<T, U, V, W>
{
	...
	static public void AddListener<TReturn>(string eventType, Func<T, U, V, W, TReturn> handler)
	{
		MessengerInternal.AddListener(eventType, handler);
	}
	...
	static public void RemoveListener<TReturn>(string eventType, Func<T, U, V, W, TReturn> handler)
	{
		MessengerInternal.RemoveListener(eventType, handler);
	}
	...
	static public void Broadcast<TReturn>(string eventType, T arg1, U arg2, V arg3, W arg4, Action<TReturn> returnCall)
	{
	...
	{
		MessengerInternal.OnBroadcasting(eventType, mode);
		var invocationList = MessengerInternal.GetInvocationList<Action<T, U, V, W>>(eventType);

		foreach (var callback in invocationList)
			callback.Invoke(arg1, arg2, arg3, arg4);
	}

	static public void Broadcast<TReturn>(string eventType, T arg1, U arg2, V arg3, W arg4, Action<TReturn> returnCall, MessengerMode mode)
	{
		MessengerInternal.OnBroadcasting(eventType, mode);
		var invocationList = MessengerInternal.GetInvocationList<Func<T, U, V, W, TReturn>>(eventType);
